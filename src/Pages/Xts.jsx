      ...
      <section className="lg:px-20 lg:pt-32 px-5 pt-20">
        <div className="flex flex-col items-center justify-center">
          ...
          <a href="https://kyc.acagarwal.com/" target="_blank">
            <button className="lg:mt-14 mt-10 flex items-center justify-center  lg:w-[184px] lg:h-[57px] h-[50px] font-poppins bg-[#244896] tracking-tight hover:bg-[#6688d1] transition-all  text-white font-normal text-[17px] rounded-[10px]">
              {" "}
              Get Started{" "}
            </button>
          </a>
