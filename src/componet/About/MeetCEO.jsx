      ...
      <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 opacity-80">
        <div className="text-[15px] lg:text-xl relative">
          <p className="text-[#161C2D]  z-50  leading-[32px]">
            ...
            <span className="mb-1 inline-block transform skew-x-[-10deg] rounded-l-sm bg-[#ADC9F8]">
              The user interface is intuitive, and the real-time
            </span>{" "}
            <span className="mb-0 inline-block transform skew-x-[-10deg] rounded-r-sm bg-[#ADC9F8]">
              {" "}
        ...
        <div className="text-[15px] lg:text-xl relative">
          <p className="text-[#161C2D]  z-50  leading-relaxed">
            ...
            <span className="mb-1 transform skew-x-[-10deg] rounded-l-sm bg-[#ADC9F8]">
              their customer support has always been top-notch.
              {/* </span>{" "}
            <span className="mb-0 transform skew-x-[-10deg] rounded-r-sm bg-[#ADC9F8]"> */}
              They patiently address all my queries, no matter
            </span>{" "}
            how basic.
          </p>
        ...
        <div className="text-[15px] lg:text-xl relative">
          <p className="text-[#161C2D]  z-50  leading-relaxed">
            ...
            The only downside is occasional lags during peak market hours.
          </p>
        ...
        <div className="text-[15px] lg:text-xl relative">
          <p className="text-[#161C2D]  z-50  leading-relaxed">
            ...
            However, the learning curve for some advanced features can be steep.
          </p>
        ...
        <div className="text-[15px] lg:text-xl relative">
          ...
          <p className="text-[#161C2D] mt-4"> Ishaan Bhatnagar, Mumbai</p>
        </div>
      </div>
    </div>
  </section>
