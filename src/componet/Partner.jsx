  ...
  return (
    <div className="max-container px-20 py-20">
      ...
      <div className="flex space-x-10 items-center mt-10">
        <img src={partner1} alt=""  className="w-[130px] h-[30px]" />
        <img src={partner2} alt=""  className="w-[190px] h-[32px]" />
        <img src={partner3} alt=""  className="w-[141px] h-[32px]" />
        <img src={partner4} alt=""  className="w-[68px] h-[28px]" />
        <img src={partner5} alt=""  className="w-[115px] h-[30px]" />
      </div>
    </div>
  );
};
