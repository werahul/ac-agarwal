    ...
    <div className="lg:pt-32 lg:pb-20 pt-20 lg:px-20 px-5 lg:bg-[#fcfdfe] bg-[#ffffff]">
      <div className="max-container">
        <div className="flex flex-col items-center justify-center mb-24">
          ...
          <h1 className="lg:hidden block font-poppins text-center font-medium  text-[30px]  leading-[50px] tracking-tight text-[#161C2DCC] mb-2">
            Innovative tools
          </h1>
          <p className="lg:hidden block font-normal font-poppins text-center   text-[20px]  leading-[30px] tracking-tight text-[#161C2DCC]">for effortless trading and investing</p>
          <p className="font-poppins text-center lg:text-[28px] text-[15px] lg:leading-[28px]  leading-[28px] lg:px-0 px-10 text-[#161C2D] opacity-60 lg:mt-8 mt-3">
