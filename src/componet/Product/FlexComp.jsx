...
const FlexComp = () => {
  return (
    <div className="lg:pt-10 lg:pb-20 pt-0 pb-0 lg:px-20 px-5  lg:bg-[#fcfdfe] bg-[#ffffff]">
      <div className="max-container lg:space-y-32 space-y-24">
        <div className="Bloom flex lg:flex-row flex-col-reverse items-start lg:space-x-32 2xl:space-x-40">
          <div className="lg:mt-0 mt-10 w-[50%]">
            <img src={bloomProduct} alt="" className="lg:w-[600px]" />
          </div>
          <div className="mt-2 w-[50%]">
            ...
            <div className="lg:flex hidden items-center space-x-2  lg:mt-[50px]">
              <a
        ...
        <div className="Math flex lg:flex-row flex-col items-center lg:space-x-32 2xl:space-x-40">
          ...
          <div className="lg:w-[50%] lg:mt-0 mt-10">
            <img src={MathProduct} alt="" className="lg:w-[580px]" />
          </div>
        </div>

        <div className="Gullak flex lg:flex-row flex-col-reverse items-center lg:space-x-32 2xl:space-x-40">
          <div className="lg:w-[50%] lg:mt-0 mt-10">
            <img src={gullakProduct} alt="" className="lg:w-[520px]" />
          </div>
          <div className="mt-2 lg:w-[55%] ">
        ...
        <div className="font-poppins">
          ...
          <div className="font-poppins lg:grid hidden grid-cols-1 gap-10 lg:grid-cols-3 lg:mb-[80px]">
            <div className="w-full lg:min-w-[380px] flex border items-start space-x-5 p-6 rounded-[22px] border-black border-opacity-15">
